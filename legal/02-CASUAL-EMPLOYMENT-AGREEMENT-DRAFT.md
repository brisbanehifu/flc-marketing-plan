...
## Builder — QBCC Nominee Supervisor (Retaining Walls)

> **DRAFT — NOT FOR SIGNATURE.** Complete every `[bracketed]` field and have a
> Queensland construction/employment lawyer review before signing. See
> `01-STRUCTURING-GUIDANCE.md` for the reasoning behind each clause.
...
**FIRST LIGHT CIVIL PTY LTD** ACN `[ACN]` ABN `[ABN]` of `[registered office address]`,
Caboolture, Queensland (**"FLC"** or **"the Employer"**)

**AND:**

**ALISTAIR COLEMAN** of `[address]` (**"the Employee"**)
...
QBCC Nominee Supervisor**, on the terms of this Agreement.

1.2 The employment is casual. There is **no firm advance commitment by FLC to continuing
and indefinite work**, and no firm advance commitment by the Employee to perform such
work. Consistent with section 15A of the *Fair Work Act 2009* (Cth):

&nbsp;&nbsp;&nbsp;&nbsp;(a) FLC is not obliged to offer any Engagement, and the Employee
is not obliged to accept any Engagement offered;

&nbsp;&nbsp;&nbsp;&nbsp;(b) there is no guaranteed pattern, roster or minimum number of
hours or Engagements; and

&nbsp;&nbsp;&nbsp;&nbsp;(c) the Employee is paid a casual loading in recognition of that
casual status.

1.3 **"Engagement"** means a discrete period of work on a specific retaining wall project
offered by FLC and accepted by the Employee, confirmed in the form of **Schedule 1**.

1.4 Each Engagement begins when the Employee commences work on it and ends when that work
is completed. This Agreement governs the terms of every Engagement but does not itself
oblige FLC to offer, or the Employee to accept, any work.

1.5 The Employee's employment commences on `[start date]` and continues on a casual basis
until ended under clause 13.

1.6 The Employee acknowledges receipt of the **Fair Work Information Statement** and the
**Casual Employment Information Statement**. FLC will provide a further copy of the
Casual Employment Information Statement at 12 months of employment and as otherwise
required by law.
...
these records being submitted.

---

## 4. Duties — supervision of retaining wall building work

4.1 The Employee's core obligation is to **adequately supervise** all retaining wall
...
&nbsp;&nbsp;&nbsp;&nbsp;(b) building approval and final certification are functions of the
**building certifier**, not the Employee; and
...
supervise. FLC must give the Employee genuine and unimpeded access to sites, documents and
personnel to enable him to discharge clause 4.1, and must not require or permit retaining
wall building work to proceed contrary to his written direction under clause 4.1(a), (b)
or (e).

---

## 5. Licences, warranties and disclosure

5.1 The Employee warrants that he holds, and will maintain for the duration of this
Agreement, a current QBCC **`[contractor's / nominee supervisor's]` licence number
`[licence no.]`, class `[class]`**, being the same class as FLC's company licence, free
of any condition or restriction that would prevent him acting as FLC's nominee.

5.2 The Employee must notify FLC **immediately, and in any event within 2 business days**,
if:

&nbsp;&nbsp;&nbsp;&nbsp;(a) his licence is suspended, cancelled, conditioned or expires;

&nbsp;&nbsp;&nbsp;&nbsp;(b) he becomes an excluded individual, becomes bankrupt, or
becomes subject to any QBCC disciplinary or exclusion action; or

&nbsp;&nbsp;&nbsp;&nbsp;(c) any other event occurs that would affect his eligibility to act
as FLC's nominee.

5.3 The Employee has disclosed to FLC every other licensee for which he acts, or proposes
to act, as nominee, and warrants that he can adequately perform the nominee role for all
of them. He must notify FLC before accepting any further nominee appointment.

5.4 FLC must notify the Employee immediately of any event affecting FLC's QBCC licence,
including any change in licence class, condition, financial category, or any exclusion
event.

5.5 The parties acknowledge that the Employee may be an **"influential person"** in
relation to FLC for the purposes of the QBCC Act, and that each party's licensing history
may affect the other's licence.
...
7.1 FLC will make superannuation contributions for the Employee at the rate required by
the *Superannuation Guarantee (Administration) Act 1992* (Cth) — currently **12%** of
ordinary time earnings — to a complying fund nominated by the Employee, or to FLC's
default fund or the Employee's stapled fund if he makes no nomination.
...
## 8. Expenses, travel and equipment

8.1 FLC will reimburse the Employee for reasonable out-of-pocket expenses properly
incurred in performing his duties, on production of receipts and with FLC's prior
approval.
...
9.1 As a casual employee, the Employee is entitled to the National Employment Standards
entitlements that apply to casual employees, including unpaid carer's leave, unpaid
compassionate leave, unpaid family and domestic violence leave (and paid family and
domestic violence leave as provided by the NES), community service leave, and — after 12
months of regular and systematic employment — unpaid parental leave and the right to
request flexible working arrangements.

9.2 The Employee is registered with **QLeave** for portable long service leave in the
building and construction industry. FLC will register as an employer with QLeave and lodge
the returns required to record the Employee's service.

9.3 FLC will maintain a **WorkCover Queensland** policy covering the Employee.

9.4 **Casual conversion.** The Employee may notify FLC under the Employee Choice Pathway in
Division 4A of Part 2-2 of the *Fair Work Act 2009* (Cth) that he believes he no longer
meets the definition of a casual employee. FLC will respond as required by that Division.

---

## 10. Work health and safety

10.1 The Employee must comply with the *Work Health and Safety Act 2011* (Qld), all
applicable codes of practice, and FLC's WHS policies and site rules.

10.2 The Employee must not direct or permit work to proceed where it would create a risk
to health or safety, and must report all incidents, injuries and hazards to FLC
immediately.

10.3 FLC will provide a safe system of work, and will not require or pressure the Employee
to approve, permit or overlook work that does not comply with the approved design or
...
11.1 The Employee must keep confidential FLC's client lists, pricing, quotations, methods
and other confidential information, during employment and afterwards, except as required
by law or as necessary to discharge his statutory duties as nominee or licensee.

11.2 The Employee must disclose to FLC any actual or potential conflict of interest,
including any competing retaining wall or earthworks business he operates or is engaged by.

11.3 Nothing in this Agreement prevents the Employee from making a disclosure to QBCC, the
Fair Work Ombudsman, a regulator, or any other person where the disclosure is required or
protected by law.

---

## 12. Intellectual property and records

12.1 All designs, drawings, records, reports and documents created by the Employee in the
course of an Engagement are the property of FLC, subject to the Employee's right to retain
copies of records relating to his own statutory obligations as nominee.

---

## 13. Ending the employment

13.1 Either party may end an individual Engagement, or the employment relationship, by
giving `[1 hour's / 1 day's]` notice, or immediately by agreement. Consistent with the
casual nature of the employment, no notice of termination or redundancy pay is payable
(the casual loading being paid in lieu).

13.2 FLC may terminate the employment immediately, without notice, for serious misconduct
or if the Employee ceases to hold the licence required by clause 5.1.

13.3 **QBCC notification.** The parties acknowledge that:

&nbsp;&nbsp;&nbsp;&nbsp;(a) if the Employee ceases to act as FLC's nominee, **QBCC must be
notified within 14 days**;

&nbsp;&nbsp;&nbsp;&nbsp;(b) FLC must not carry out or undertake to carry out building work
while it has no nominee, and commits an offence if it is without a nominee for **28 days or
more**; and

&nbsp;&nbsp;&nbsp;&nbsp;(c) each party will do all things reasonably necessary to give
effect to (a), including signing the relevant QBCC forms.

13.4 The Employee must give FLC **`[4 / 8]` weeks' notice** before resigning as nominee
(as distinct from declining Engagements), so that FLC can appoint a replacement within the
28-day period. This clause survives termination of the employment.

13.5 On termination, the Employee must return all FLC property, documents and records.

---

## 14. General

14.1 **Governing law.** This Agreement is governed by the laws of Queensland.

14.2 **Entire agreement.** This Agreement, together with its Schedules, is the entire
agreement between the parties and replaces all prior agreements and understandings.

14.3 **Variation.** This Agreement may only be varied in writing signed by both parties,
except that FLC may increase the Hourly Rate unilaterally.

14.4 **Statutory entitlements prevail.** Nothing in this Agreement operates to exclude,
modify or reduce any entitlement under the *Fair Work Act 2009* (Cth), the National
Employment Standards, any applicable modern award, or any other law. To the extent of any
inconsistency, that law prevails.

14.5 **Severance.** If any clause is invalid or unenforceable, it is severed and the rest
of the Agreement continues.
...
**SIGNED for and on behalf of FIRST LIGHT CIVIL PTY LTD** ACN `[ACN]`:
...
*One per retaining wall project. Offer, acceptance and job record in a single page.*
...
FLC representative: ............................ Date: ....................

**Acceptance.** The Employee accepts / declines this Engagement. The Employee acknowledges
this Engagement carries no commitment to any further work.

Employee: ............................ Date: ....................

**Hours worked (completed at end of Engagement)**
...
# SCHEDULE 2 — Nominee Supervision Record

*One per site attendance. Retain for 7 years. This is FLC's evidence of adequate
supervision under s 43A of the QBCC Act.*
...
**Certificates obtained this visit** (Form 12 / Form 16 / other):
